...
export const metadata: Metadata = {
  title: 'localtool — Local development infrastructure',
  description: 'localtool: unified CLI for local DNS management and HTTPS certificates. Open-source developer tools.',
  metadataBase: new URL('https://localtool.vercel.app'),
  openGraph: {
    title: 'localtool — Local development infrastructure',
    description: 'localtool: unified CLI for local DNS and HTTPS certificates. Open-source developer tools.',
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-40 flex justify-center pt-4">
      <nav className="flex items-center gap-6 px-6 py-3 bg-[#0a0a14]/90 backdrop-blur-2xl border border-white/[0.06] rounded-full shadow-[0_0_0_1px_rgba(99,102,241,0.08)]">
        <a href="/" className="font-semibold tracking-tight text-sm text-white/90 hover:text-white transition-colors">localtool</a>
        ...
        <a href="https://github.com/veduket/localtool" target="_blank" rel="noopener noreferrer" className="text-sm text-white/50 hover:text-white/80 transition-colors">GitHub</a>
      </nav>
    </header>
  )
}
